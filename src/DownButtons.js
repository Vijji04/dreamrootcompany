...
function DownButtons() {
  return (
    <div className='container mx-5 px-5'>
        ...
        <button className='text-bold text-xs p-1 px-2 pt-2 pl-1 flex justify-center outline outline-offset-2 outline-1 border-[#999999]    text-black w-24 h-8 rounded-full baseline shadow-6xl'>
